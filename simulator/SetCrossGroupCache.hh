#ifndef __SET_CROSS_GROUP_CACHE_HH__
#define __SET_CROSS_GROUP_CACHE_HH__
...
#define LINE_BIT 3
#define LINE_MASK 0x70000
#define STRIP_BIT 10
#define STRIP_MASK 0xFFC0
#define TAG_BIT 13
#define TAG_MASK 0xFFF80000
#define GROUP_BIT 3
#define GROUPSIZE 8

class SetCrossGroupCache : public BaseCache {
    struct SMUEntry {
        Tick lastAccessTick;
        uint64_t tag;
        bool valid;
...
public:
    SetCrossGroupCache(callback_type callback):BaseCache(callback){
